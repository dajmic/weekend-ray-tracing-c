...
$(OBJDIR)main: $(OBJDIR)vec3.o $(OBJDIR)colour.o $(OBJDIR)sphere.o $(OBJDIR)ray.o
	$(CC) $(CFLAGS) -o $(OBJDIR)main $(SRCDIR)main.c $(OBJDIR)vec3.o $(OBJDIR)colour.o $(OBJDIR)sphere.o $(OBJDIR)ray.o -lm
...
clean:
	$(RM) $(OBJDIR)main $(OBJDIR)ray.o $(OBJDIR)colour.o $(OBJDIR)vec3.o $(OBJDIR)sphere.o $(OBJDIR)main.dSYM